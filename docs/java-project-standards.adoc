...
All projects MUST maintain 80% code coverage on all Java classes.

==== Coverage Requirements

* **Minimum Coverage**: 80% line and branch coverage on all Java classes
...
Review `target/site/jacoco/index.html` to ensure 80% coverage on all Java classes.
...
sonar.sources=modules/core-platform/src/main/java,modules/core-platform/src/main/webui/src
sonar.tests=modules/core-platform/src/test/java

sonar.sourceEncoding=UTF-8

sonar.java.source=21
sonar.java.binaries=modules/core-platform/target/classes
sonar.java.test.binaries=modules/core-platform/target/test-classes

sonar.coverage.jacoco.xmlReportPaths=modules/core-platform/target/site/jacoco/jacoco.xml
