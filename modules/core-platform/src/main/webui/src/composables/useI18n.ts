...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'loyalty.program.builderTitle': 'Program Configuration',
    'loyalty.program.builderSubtitle': 'Tune earn rates, redemption, and expiration',
    'loyalty.program.enabledLabel': 'Program enabled',
    'loyalty.program.nameLabel': 'Program name',
    'loyalty.program.descriptionLabel': 'Description',
    'loyalty.program.minRedemption': 'Minimum redemption',
    'loyalty.program.maxRedemption': 'Maximum redemption',
    'loyalty.program.pilotToggle': 'Restrict to pilot tenants',
    'loyalty.program.addTier': 'Add tier',
    'loyalty.program.removeTier': 'Remove',
    'loyalty.program.previewTitle': 'Reward preview',
    'loyalty.program.previewSubtitle': 'Sample spend → earn projections',
    'loyalty.program.previewSpend': 'Spend',
    'loyalty.program.previewEarn': 'Earns {points} pts',
    'loyalty.program.previewRedeem': '≈ {value} value',
    'loyalty.program.save': 'Save program',
    ...
    'loyalty.errors.saveFailed': 'Failed to save program',
    'loyalty.messages.adjusted': 'Points adjusted',
    'loyalty.messages.saved': 'Program updated',
    'loyalty.pilotGuardTitle': 'Pilot controls disabled',
    'loyalty.pilotGuardCopy': 'Enable the loyalty-pilot flag for this tenant to edit configuration.',
  ...
  es: {
    ...
    'loyalty.program.builderTitle': 'Configuración del programa',
    'loyalty.program.builderSubtitle': 'Ajusta ganancias, redenciones y expiración',
    'loyalty.program.enabledLabel': 'Programa activo',
    'loyalty.program.nameLabel': 'Nombre del programa',
    'loyalty.program.descriptionLabel': 'Descripción',
    'loyalty.program.minRedemption': 'Redención mínima',
    'loyalty.program.maxRedemption': 'Redención máxima',
    'loyalty.program.pilotToggle': 'Restringir a arrendatarios piloto',
    'loyalty.program.addTier': 'Agregar nivel',
    'loyalty.program.removeTier': 'Eliminar',
    'loyalty.program.previewTitle': 'Vista previa de recompensas',
    'loyalty.program.previewSubtitle': 'Ejemplos de gasto y puntos',
    'loyalty.program.previewSpend': 'Gasto',
    'loyalty.program.previewEarn': 'Gana {points} pts',
    'loyalty.program.previewRedeem': '≈ {value} en valor',
    'loyalty.program.save': 'Guardar programa',
    'loyalty.errors.saveFailed': 'No se pudo guardar el programa',
    'loyalty.messages.saved': 'Programa actualizado',
    'loyalty.pilotGuardTitle': 'Solo para pilotos',
    'loyalty.pilotGuardCopy': 'Active la bandera loyalty-pilot para editar la configuración.',
